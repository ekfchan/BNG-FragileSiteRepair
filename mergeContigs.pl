...
#Usage: perl mergeContigs.pl <input CMAP> <first_contig_ID> <+/- orientation> <second_contig_ID> <+/- orientation> <N bases to add in-between> <bp from end of first contig to insert an extra label>
