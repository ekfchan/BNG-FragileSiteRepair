...
setVersion("$Id: utilities.py 3985 2015-07-28 00:58:01Z wandrews $") #use above for this file
...
def getRefAlignerVersion(rabin) :
    """Call rabin (must be path to RefAligner) with -v argument, parse result,
    ...
    #if len(version) < 4 : #and fourth word
    #    return None
    #return version[3]
    #don't assume word index: loop to find string
    for word in version :
