...
"x86_64-linux-thread-multi-3.10.0-123.13.2.el7.centos.plus.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-3.10.0-123.13.2.el7.centos.plus.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
